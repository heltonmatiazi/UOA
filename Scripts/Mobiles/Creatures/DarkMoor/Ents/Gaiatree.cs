...
namespace Server.Mobiles
{
	...
	public class GaiaTree : BaseCreature
	{
		[Constructable]
		public GaiaTree() : base( AIType.AI_Mage, FightMode.Closest, 15, 1, 0.2, 0.4 )
		{
			Name = NameList.RandomName( "trees" );
			Title = "the Gaian tree";
			Body = 313;
			BaseSoundID = 442;
		...
		public GaiaTree( Serial serial ) : base( serial )
		{
		}
