...
namespace Server.Mobiles
{
	...
	public class Hermit : BaseCreature
	{
		...
		[Constructable]
		public Hermit() : base( AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
		...
		public override void OnThink()
		{
			if ( this.m_NextSpawn <= DateTime.Now && this.m_Spawns != null && this.m_Spawns.Count < 5 )
			{
				...
				this.m_NextSpawn = DateTime.Now + TimeSpan.FromSeconds( 90.0 );
			}
		...
		public Hermit( Serial serial ) : base( serial )
		{
		}
