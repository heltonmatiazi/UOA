...
{ 
	public class BasePerson : BaseConvo
	{
		...
		public override bool IsEnemy( Mobile m )
		{
			...
			if (this is TownHerald && ( Server.Misc.Worlds.GetRegionName( this.Map, this.Location ) == "DarkMoor" || Server.Misc.Worlds.GetRegionName( this.Map, this.Location ) == "the Temple of Praetoria") && m.Karma <= 0 )
				return false;
