...
namespace Server.Mobiles
{
	...
	{ 
		...
		{ 
			public InternalBuyInfo() 
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( PoorMiningHarvester ), 25000, Utility.Random( 1,2 ), 0x5484, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( StandardMiningHarvester ), 75000, Utility.Random( 1,2 ), 0x5484, 0 ) ); }
				if ( MyServerSettings.SellRareChance() ){Add( new GenericBuyInfo( typeof( GoodMiningHarvester ), 175000, Utility.Random( 1,2 ), 0x5484, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( PoorLumberHarvester ), 25000, Utility.Random( 1,2 ), 0x5486, 0 ) ); }
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( PoorHideHarvester ), 25000, Utility.Random( 1,2 ), 0x5487, 0 ) ); }
	...
	public class SBBuyArtifacts: SBInfo
	{
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AbysmalGloves ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AcidProofRobe ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Aegis ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AngelicEmbrace ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AngeroftheGods ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Annihilation ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneArms ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneCap ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneGloves ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneGorget ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneLeggings ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneShield ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneTunic ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcanicRobe ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcticBeacon ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcticDeathDealer ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmorOfFortune ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmorOfInsight ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmorOfNobility ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfAegis ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfFortune ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfInsight ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfNobility ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfTheFallenKing ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfTheHarrower ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfToxicity ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AuraOfShadows ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BalancingDeed ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BlazeOfDeath ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BookOfKnowledge ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BowOfTheJukaKing ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BraceletOfHealth ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BraceletOfTheElements ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BraceletOfTheVile ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BreathOfTheDead ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BurglarsBandana ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Calm ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandelabraOfSouls ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CapOfFortune ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CapOfTheFallenKing ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CavortingClub ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CircletOfTheSorceress ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CoifOfBane ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CoifOfFire ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ColdBlood ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CrimsonCincture ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CrownOfTalKeesh ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DarkGuardiansChest ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DarkLordsPitchfork ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DarkNeck ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DeathsMask ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineArms ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineCountenance ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineGloves ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineGorget ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineLeggings ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineTunic ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DjinnisRing ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DreadPirateHat ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DupresCollar ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DupresShield ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringBoxSet ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfHealth ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfProtection ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfTheElements ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfTheMagician ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfTheVile ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ElvenQuiver ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EmbroideredOakLeafCloak ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EnchantedTitanLegBone ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EternalFlame ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EvilMageGloves ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FalseGodsScepter ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FangOfRactus ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FesteringWound ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Fortifiedarms ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FortunateBlades ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Frostbringer ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FurCapeOfTheSorceress ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Fury ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GauntletsOfNobility ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GeishasObi ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GladiatorsCollar ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlassSword ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfAegis ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfCorruption ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfFortune ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfInsight ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfRegeneration ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfTheFallenKing ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfTheHarrower ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfThePugilist ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GorgetOfAegis ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GorgetOfFortune ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GorgetOfInsight ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GuantletsOfAnger ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GwennosHarp ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HatOfTheMagi ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HeartOfTheLion ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HellForgedArms ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HelmOfAegis ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HelmOfInsight ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsArmPlates ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsBreastplate ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsGloves ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsGorget ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsLegging ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsPlateHelm ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolySword ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersArms ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersGloves ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersGorget ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersHeaddress ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersLeggings ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersTunic ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Indecency ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsArms ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsGorget ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsHelm ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsLeggings ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsResolution ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsTunic ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( IolosLute ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsArms ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsCollar ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsGloves ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsHelm ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsLeggings ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsTunic ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JadeScimitar ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JesterHatofChuckles ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JinBaoriOfGoodFortune ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( KamiNarisIndestructableDoubleAxe ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegacyOfTheDreadLord ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfAegis ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfBane ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfDeceit ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfEnlightenment ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfFire ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfFortune ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfInsight ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfNobility ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfTheFallenKing ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfTheHarrower ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LieutenantOfTheBritannianRoyalGuard ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LongShot ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LuckyEarrings ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LuckyNecklace ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LunaLance ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MadmansHatchet ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MagesBand ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MagiciansIllusion ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MagiciansMempo ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MarbleShield ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MauloftheBeast ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WizardsPants ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightBracers ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightGloves ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightHelm ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightLegs ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightTunic ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MinersPickaxe ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NightsKiss ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NordicVikingSword ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NoxBow ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NoxNightlight ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NoxRangersHeavyCrossbow ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OblivionsNeedle ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OrcChieftainHelm ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OrcishVisage ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OrnamentOfTheMagician ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OrnateCrownOfTheHarrower ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Pestilence ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PixieSwatter ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PolarBearMask ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PowerSurge ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Quell ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( QuiverOfBlight ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( QuiverOfElements ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( QuiverOfFire ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( QuiverOfIce ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( QuiverOfInfinity ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( QuiverOfLightning ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( QuiverOfRage ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RamusNecromanticScalpel ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Retort ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RighteousAnger ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RingOfHealth ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RingOfTheElements ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RingOfTheMagician ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RingOfTheVile ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobeOfTheEclipse ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobeOfTheEquinox ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobeOfTreason ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RoyalArchersBow ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RoyalGuardsChestplate ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RoyalGuardsGorget ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RoyalGuardSurvivalKnife ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SamaritanRobe ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SamuraiHelm ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SerpentsFang ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowBlade ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerArms ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerCap ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerGloves ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerGorget ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerLeggings ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerTunic ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShaminoCrossbow ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShieldOfInvulnerability ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShimmeringTalisman ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShroudOfDeciet ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SoulSeeker ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SpiritOfTheTotem ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SprintersSandals ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( StaffOfPower ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( StaffOfTheMagi ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Subdue ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SwiftStrike ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TalonBite ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheBeserkersMaul ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheDryadBow ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheDragonSlayer ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheRobeOfBritanniaAri ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheTaskmaster ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TitansHammer ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemArms ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemGloves ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemGorget ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemLeggings ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemOfVoid ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemTunic ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TownGuardsHalberd ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfAegis ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfBane ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfFire ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfTheFallenKing ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfTheHarrower ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( VampiricDaisho ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( VioletCourage ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( VoiceOfTheFallenKing ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WarriorsClasp ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WeaponRenamingTool ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WildfireBow ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Windsong ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WrathOfTheDryad ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( YashimotosHatsuburi ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ZyronicClaw ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EverlastingLoaf ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EverlastingBottle ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PolarBearCape ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PolarBearBoots ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Excalibur ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( KodiakBearMask ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Stormbringer ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AchillesShield ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AchillesSpear ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( StaffofSnakes ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AilricsLongbow ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LargeBagofHolding ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MediumBagofHolding ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SmallBagofHolding ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BagOfHolding ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BootsofHermes ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BeltofHercules ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobinHoodsFeatheredHat ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobinHoodsBow ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AxeoftheMinotaur ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BowofthePhoenix ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GandalfsRobe ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GandalfsHat ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GandalfsStaff ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HammerofThor ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ConansSword ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ConansHelm ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SinbadsSword ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GiantBlackjack ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleCold ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleFire ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandlePoison ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleEnergy ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleWizard ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleNecromancer ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TorchOfTrapFinding ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RodOfResurrection ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobeOfTeleportation ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MaulOfTheTitans ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HelmOfBrilliance ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfDexterity ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GemOfSeeing ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DaggerOfVenom ), Utility.Random( 25000,75000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ColoringBook ), Utility.Random( 25000,75000 ) ); } 
			}
		}
	}
	///////////////////////////////////////////////////////////////////////////////////////////////////////////
