	...
	public class PlayerMobile : Mobile, IHonorTarget
	{
	  ...
	  /* End Captcha Mod *///////////////////////////////////////////
		...
		*/
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public bool BalanceChampion
		{
			get{ return GetFlag( PlayerFlag.BalanceChampion ); }
			set{ SetFlag( PlayerFlag.BalanceChampion, value ); }
		}
		...
		{			
			...
			if ( DateTime.Now >= m_NextSound && Utility.RandomBool() && MyServerSettings.EnableAmbientSoundEffects() )
			{		
		...
		private class CancelRenewInventoryInsuranceGump : Gump
		{
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( info.ButtonID == 1 )
				{
					...
					//m_Player.BalanceChampion = false;
				}
				else
				{
		...
		public override void OnDamage( int amount, Mobile from, bool willKill )
		{
			...
			if ( from != null && ((double)this.Hits / (double)this.HitsMax) <= 0.10 && this.BodyMod == 263 )
				MinotaurCloak.UseMinotaurAbility( this );

			if ( from != null && ((double)this.Hits / (double)this.HitsMax) <= 0.60 && this.BodyMod == 318 )
			{
		...
		public override void OnDeath( Container c )
		{
			...
			double changechange = (double)this.Karma / 500; 
		...
		public static bool MovementThrottle_Callback( NetState ns )
		{
			...
			if ( pm != null )
			{
				if ( pm.FindItemOnLayer( Layer.Shoes ) != null )
				{
					...
					if ( shoes is BootsofHermes ){ return true; }
				}
