...
namespace Server.Mobiles 
{
	...
	{ 
	    private HenchmanWizard pk;

	    public BandageTimer( HenchmanWizard o ) : base( TimeSpan.FromSeconds( 5 ) ) 
	    { 
		pk = o;
	    ...
	    public HenchmanWizard( int myBody, int nMounted, double nSkills, int nStats ) : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 ) 
	{
	    ...
	    int nProtect = (int)(nStats / 5); if ( nProtect > 70 ){ nProtect = 70; }
	    ...
	    SetSkill(SkillName.Healing, 40, 60 );
