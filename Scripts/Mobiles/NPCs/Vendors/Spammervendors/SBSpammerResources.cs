		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			...
			{  
				...
				if (Utility.RandomDouble() > 0.70)
					Add( new GenericBuyInfo( "Gold ingots", typeof( GoldIngot ), 50, 10000, 0x1BF2, 0 ) );		
				if (Utility.RandomDouble() > 0.75)
					Add( new GenericBuyInfo( "Agapite Ingots", typeof( AgapiteIngot ), 60, 10000, 0x1BF2, 0 ) );		
				if (Utility.RandomDouble() > 0.80)
					Add( new GenericBuyInfo( "Verite Ingots", typeof( VeriteIngot ), 75, 10000, 0x1BF2, 0 ) );	
				if (Utility.RandomDouble() > 0.90)
					Add( new GenericBuyInfo( "Val Ingots", typeof( ValoriteIngot ), 100, 10000, 0x1BF2, 0 ) );	
