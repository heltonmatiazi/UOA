...
namespace Server.Mobiles
{
    public class ShardGreeter : BasePerson
	{
		...
		{ 
			public chatTimer() : base( TimeSpan.FromSeconds( 15 ) ) 
			{ 
      ...
      public override void OnSpeech( SpeechEventArgs e ) 
      {
      	...
      	{
	    if ( ( e.Speech.ToLower() == "benefits" ) )//was sellpet
	    {
			this.Say("The world is governed by a Mystical Balance - those brave enough to enter without restrictions will have greater impact on this balance, and may be crowned champions.  They also benefit from bonuses on their daily adventures and a higher stat cap.");
	    }
	    else if ( ( e.Speech.ToLower() == "perils" ) )
	    {
			this.Say("Those who seek to play without restrictions may lose some of their skill when travelling the Aether or after being resurrected.");
	    }
	    else 
	    { 
		base.OnSpeech( e ); 
