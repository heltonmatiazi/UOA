...
namespace Server.Misc
{
    class IntelligentAction
    {
		public static bool GetMyEnemies( Mobile m, Mobile me, bool checkDisguise )
		{
			...
			if ( m is PlayerMobile && me is BaseVendor && ( (Server.Misc.Worlds.GetRegionName( me.Map, me.Location ) == "The Pit") || (Server.Misc.Worlds.GetRegionName( me.Map, me.Location ) == "the Town of Skara Brae") || (Server.Misc.Worlds.GetRegionName( me.Map, me.Location ) == "Lamut County") || (Server.Misc.Worlds.GetRegionName( me.Map, me.Location ) == "the Ruins of Tenebrae") || reg.IsPartOf(typeof(SafeRegion) ) || reg.IsPartOf(typeof(PublicRegion)) ) && ( m.Kills > 0 || m.Karma <=  -5000) )
				return false;
		...
		public static void DressUpFighters( Mobile m, string race, bool isEnemy )
		{
		...
		public static void DressUpRogues( Mobile m, string race, bool isEnemy )
		{
		...
		public static void ChooseFighter( Mobile m, string race )
		{
			...
			{
				Server.Misc.IntelligentAction.DressUpFighters( m, race, true );
			}
			else 
			{
				Server.Misc.IntelligentAction.DressUpFighters( m, race, true );
