...
//final lottery speak
		...
		public static string LogInvestments( Mobile m, int goldearned, bool gain )
		{
			...
			//{
				string sEvent = "";
				if (gain)
					sEvent = m.Name + " " + sTitle + " earned " + goldearned + " gold on his investments!" + "#" + sDateString;
				else
					sEvent = m.Name + " " + sTitle + " lost " + goldearned + " gold on his investments!" + "#" + sDateString;
		...
		public static string LogZombie( Mobile m )
		{
			...
			////if (pm.PublicMyRunUO == true)
			//{
				string sEvent = m.Name + " " + sTitle + " died and rose again as a deadly Zombie!! "+ "#" + sDateString;
				LoggingFunctions.LogEvent( sEvent, "Logging Misc" );
			//}
		...
		public static string LogCarve( Mobile m, string name )
		{
			...
			////if (pm.PublicMyRunUO == true)
			//{
				string sEvent = "In an unmitigated act of pure bloodlust, " + m.Name + " " + sTitle + " butchered the " + name + "#" + sDateString;
				LoggingFunctions.LogEvent( sEvent, "Logging Misc" );
			//}
