...
namespace Server.Misc
{
	public class MapDefinitions
	{
		public static void Configure()
		{
			...
			RegisterMap( 0, 0, 0, 7168, 4096, 1, "Felucca",		MapRules.FeluccaRules | MapRules.FreeMovement );
			RegisterMap( 1, 1, 1, 7168, 4096, 1, "Trammel",		MapRules.FeluccaRules | MapRules.FreeMovement );
			RegisterMap( 2, 2, 2, 2304, 1600, 1, "Ilshenar",	MapRules.FeluccaRules | MapRules.FreeMovement );
			RegisterMap( 3, 3, 3, 2560, 2048, 1, "Malas",		MapRules.FeluccaRules | MapRules.FreeMovement );
			RegisterMap( 4, 4, 4, 1448, 1448, 1, "Tokuno",		MapRules.FeluccaRules | MapRules.FreeMovement );
			RegisterMap( 5, 5, 5, 1280, 4096, 1, "TerMur",		MapRules.FeluccaRules | MapRules.FreeMovement );
