		...
		public static readonly LootPack SeRich = new LootPack( new LootPackEntry[]
			{
				...
				new LootPackEntry( false, AosMagicItemsRichType1,	 20.30, 1, 4, 10, 75 ),
				new LootPackEntry( false, AosMagicItemsRichType2,	 15.70, 1, 5, 25, 100 ),
				new LootPackEntry( false, Instruments,				  3.00, 1, 4, 15, 75 ),
				new LootPackEntry( false, Quivers,				  	  2.00, 1, 4, 15, 75 ),
				new LootPackEntry( false, SArtyItems,				  1.00, 1, 4, 15, 75 )
			} );

		public static readonly LootPack SeFilthyRich = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						   100.00, "3d100+400" ),
				new LootPackEntry( false, AosMagicItemsFilthyRichType1,	40.50, 1, 5, 35, 100 ),
				new LootPackEntry( false, AosMagicItemsFilthyRichType2,	27.60, 1, 5, 50, 100 ),
				new LootPackEntry( false, Instruments,					 4.00, 1, 5, 25, 100 ),
				new LootPackEntry( false, Quivers,				  	  	 2.00, 1, 5, 25, 100 ),
		...
		public static readonly LootPack SeUltraRich = new LootPack( new LootPackEntry[]
			{
				...
				new LootPackEntry( false, AosMagicItemsUltraRich,	10.00, 1, 5, 80, 100 ),
				new LootPackEntry( false, Instruments,				  5.00, 1, 5, 50, 100 ),
				new LootPackEntry( false, Quivers,				  	  3.00, 1, 5, 50, 100 ),
				new LootPackEntry( false, SArtyItems,				  1.00, 1 ),
		...
		public static readonly LootPack SeSuperBoss = new LootPack( new LootPackEntry[]
			{
				...
				new LootPackEntry( false, AosMagicItemsUltraRich,	50.00, 1, 5, 55, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	40.00, 1, 5, 65, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	20.00, 1, 5, 75, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	10.00, 1, 5, 90, 100 ),
				new LootPackEntry( false, Instruments,				  5.00, 1, 5, 66, 100 ),
				new LootPackEntry( false, Quivers,				  	  4.00, 1, 5, 66, 100 ),
		...
		public static readonly LootPack AosPoor = new LootPack( new LootPackEntry[]
			{
				...
				new LootPackEntry( false, AosMagicItemsPoor,	  0.06, 1, 3, 0, 90 ),
				new LootPackEntry( false, Instruments,	  		  0.04, 1, 3, 0, 90 ),
				new LootPackEntry( false, Quivers,		  		  0.02, 1, 3, 0, 90 )
			} );

		public static readonly LootPack AosMeager = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						100.00, "3d10+20" ),
				new LootPackEntry( false, AosMagicItemsMeagerType1,	  1.00, 1, 3, 0, 25 ),
				new LootPackEntry( false, AosMagicItemsMeagerType2,	  0.30, 1, 4, 15, 90 ),
		...
		public static readonly LootPack AosAverage = new LootPack( new LootPackEntry[]
			{
				...
				new LootPackEntry( false, AosMagicItemsAverageType1,  2.00, 1, 3, 10, 50 ),
				new LootPackEntry( false, AosMagicItemsAverageType2,  0.50, 1, 4, 25, 90 ),
		...
		public static readonly LootPack AosRich = new LootPack( new LootPackEntry[]
			{
				...
				new LootPackEntry( false, AosMagicItemsRichType1,	 10.00, 1, 4, 10, 50 ),
				new LootPackEntry( false, AosMagicItemsRichType1,	 5.00, 1, 5, 10, 75 ),
				new LootPackEntry( false, AosMagicItemsRichType2,	  1.00, 1, 5, 25, 90 ),
				new LootPackEntry( false, SArtyItems,	  			  1.00, 1 ),
		...
		public static readonly LootPack AosFilthyRich = new LootPack( new LootPackEntry[]
			{
				...
				new LootPackEntry( false, AosMagicItemsFilthyRichType1,	 10.00, 1, 4, 10, 75 ),
				new LootPackEntry( false, AosMagicItemsFilthyRichType2,	 5.00, 1, 5, 25, 90 ),
				new LootPackEntry( false, AosMagicItemsFilthyRichType2,	  1.00, 1, 5, 50, 100 ),
				new LootPackEntry( false, Instruments,					  2.00, 1, 4, 0, 90 ),
				new LootPackEntry( false, Quivers,				  	 	  2.00, 1, 4, 0, 90 ),
		...
		public static readonly LootPack AosUltraRich = new LootPack( new LootPackEntry[]
			{
				...
				new LootPackEntry( false, AosMagicItemsUltraRich,	50.00, 1, 5, 40, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	25.00, 1, 5, 50, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	10.00, 1, 5, 75, 100 ),
				new LootPackEntry( false, Instruments,	 			  2.00, 1, 5, 33, 100 ),
				new LootPackEntry( false, Quivers,				  	  1.00, 1, 5, 33, 100 ),
				new LootPackEntry( false, SArtyItems,	  			  3.00, 1 ),
		...
		public static readonly LootPack AosSuperBoss = new LootPack( new LootPackEntry[]
			{
				...
				new LootPackEntry( false, AosMagicItemsUltraRich,	20.00, 1, 5, 75, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	10.00, 1, 5, 90, 100 ),
				new LootPackEntry( false, Instruments,	 			  5.00, 1, 5, 80, 100 ),
				new LootPackEntry( false, Quivers,				  	  4.00, 1, 5, 80, 100 ),
