...
namespace Server.Misc
{
    class GetPlayerInfo
    {
		...
		public static bool LuckyPlayer( int luck )
		{
			...
			int boostluck = Utility.RandomMinMax (1, 8);
			...
			int clover = (int)(luck * 0.05); // RETURNS A MAX OF 100%

			if (  clover >= Utility.RandomMinMax( 1, 180 ) )
				return true;
		...
		public static bool LuckyKiller( int luck )
		{
			...
			int clover = (int)(luck * 0.04) + 10; // RETURNS A MAX OF 80%

			if ( clover >= Utility.RandomMinMax( 1, 200 ) )
				return true;
