...
namespace Server.Misc
{
    class MyServerSettings
    {
		...
		public static string FilesPath()
		{
			...
			return @"C:\Ultima-Adventures\UOA\Files";
		}
		...
		public static void AdditionalHitPoints( BaseCreature bc, int DungeonDifficulty )
		{
			...
			else if ( DungeonDifficulty == 2 ){ HitPercents = Utility.RandomMinMax( 65, 95 )*0.01; }
			else if ( DungeonDifficulty == 3 ){ HitPercents = Utility.RandomMinMax( 90, 125 )*0.01; }		// LEVEL 3 DUNGEONS
			else if ( DungeonDifficulty > 3 ){ HitPercents = Utility.RandomMinMax( 125, 175 )*0.01; }			// LEVEL 4 DUNGEONS
		...
		{
			int chance = 55;	if ( chance >= Utility.RandomMinMax( 1, 100 ) ){ return true; }
			return false;
		}
