    ...
    public class EnhancementUtility
    {
        ...
        public static int GetValue(AosArmorAttribute attribute)
        {
            switch (attribute)
            {
                ...
                case AosArmorAttribute.LowerStatReq: { return Utility.RandomMinMax(4, 10); }
                case AosArmorAttribute.MageArmor: { return 1; }
                case AosArmorAttribute.SelfRepair: { return Utility.RandomMinMax(3, 12); }
        ...
        public static int GetValue(AosAttribute attribute)
        {
            ...
            {
                //**************** MAKE CHANGES STARTING HERE ****************************
                case AosAttribute.RegenHits: { return Utility.RandomMinMax(5, 25); }
                case AosAttribute.RegenStam: { return Utility.RandomMinMax(5, 25); }
                case AosAttribute.RegenMana: { return Utility.RandomMinMax(5, 25); }
                case AosAttribute.DefendChance: { return Utility.RandomMinMax(5, 40); }
                case AosAttribute.AttackChance: { return Utility.RandomMinMax(5, 40); }
                case AosAttribute.BonusStr: { return Utility.RandomMinMax(2, 20); }
                case AosAttribute.BonusDex: { return Utility.RandomMinMax(2, 20); }
                case AosAttribute.BonusInt: { return Utility.RandomMinMax(2, 20); }
                case AosAttribute.BonusHits: { return Utility.RandomMinMax(5, 50); }
                case AosAttribute.BonusStam: { return Utility.RandomMinMax(10, 50); }
                case AosAttribute.BonusMana: { return Utility.RandomMinMax(10, 50); }
                case AosAttribute.WeaponDamage: { return Utility.RandomMinMax(5, 30); }
                case AosAttribute.WeaponSpeed: { return Utility.RandomMinMax(5, 30); }
                case AosAttribute.SpellDamage: { return Utility.RandomMinMax(10, 40); }
                case AosAttribute.CastRecovery: { return Utility.RandomMinMax(5, 30); }
                case AosAttribute.CastSpeed: { return Utility.RandomMinMax(5, 30); }
                case AosAttribute.LowerManaCost: { return Utility.RandomMinMax(4, 30); }
                case AosAttribute.LowerRegCost: { return Utility.RandomMinMax(10, 25); }
                case AosAttribute.ReflectPhysical: { return Utility.RandomMinMax(10, 50); }
                case AosAttribute.EnhancePotions: { return Utility.RandomMinMax(10, 50); }
        ...
        public static int GetValue(AosWeaponAttribute attribute)
        {
            ...
            {
                //**************** MAKE CHANGES STARTING HERE ****************************
                case AosWeaponAttribute.HitLeechHits: { return Utility.RandomMinMax(5, 30); }
                case AosWeaponAttribute.HitLeechStam: { return Utility.RandomMinMax(5, 30); }
                case AosWeaponAttribute.HitLeechMana: { return Utility.RandomMinMax(5, 30); }
                case AosWeaponAttribute.HitLowerAttack: { return Utility.RandomMinMax(5, 30); }
                case AosWeaponAttribute.HitLowerDefend: { return Utility.RandomMinMax(5, 30); }
                case AosWeaponAttribute.HitMagicArrow: { return Utility.RandomMinMax(5, 30); }
                case AosWeaponAttribute.HitHarm: { return Utility.RandomMinMax(5, 30); }
                case AosWeaponAttribute.HitFireball: { return Utility.RandomMinMax(5, 30); }
                case AosWeaponAttribute.HitLightning: { return Utility.RandomMinMax(5, 30); }
                case AosWeaponAttribute.HitDispel: { return Utility.RandomMinMax(5, 30); }
                case AosWeaponAttribute.HitColdArea: { return Utility.RandomMinMax(2, 16); }
                case AosWeaponAttribute.HitFireArea: { return Utility.RandomMinMax(2, 16); }
                case AosWeaponAttribute.HitPoisonArea: { return Utility.RandomMinMax(2, 16); }
                case AosWeaponAttribute.HitEnergyArea: { return Utility.RandomMinMax(2, 16); }
                case AosWeaponAttribute.HitPhysicalArea: { return Utility.RandomMinMax(2, 16); }
                ...
                case AosWeaponAttribute.LowerStatReq: { return Utility.RandomMinMax(4, 10); }
                case AosWeaponAttribute.SelfRepair: { return Utility.RandomMinMax(3, 12); }
                //**************** MAKE CHANGES ENDING HERE ****************************
            }
            return 0;
        }
