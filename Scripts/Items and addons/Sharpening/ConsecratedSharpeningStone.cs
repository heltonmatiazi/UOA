...
namespace Server.Items
{
	public class ConsecratedSharpeningStone : Item
	{
		...
		[Constructable] 
		public ConsecratedSharpeningStone( int uses ) : base( 0x1F14 ) 
		{ 
			Weight = 1.0;
			i_Uses = uses;
			Hue = 0x38C;
	...
	public class ConsecratedSharpeningStoneTarget : Target
	{
		...
		public ConsecratedSharpeningStoneTarget(ConsecratedSharpeningStone blade) : base( 18, false, TargetFlags.None )
		{
			sb_Blade = blade;
		}
