...
namespace Server.Items
{
	...
	public class LevelAttributes
	{
		...
		{
			new AttributeInfo( AosAttribute.RegenHits, "Regen Hits", AttributeCategory.Stats, 5, 10 ),
			new AttributeInfo( AosAttribute.RegenStam, "Regen Stamina", AttributeCategory.Stats, 5, 10 ),
			new AttributeInfo( AosAttribute.RegenMana, "Regen Mana", AttributeCategory.Stats, 5, 10 ),
			new AttributeInfo( AosAttribute.DefendChance, "Defence Chance Increase", AttributeCategory.Melee, 8, 20 ),
			new AttributeInfo( AosAttribute.AttackChance, "Hit Chance Increase", AttributeCategory.Melee, 10, 20 ),
			...
			new AttributeInfo( AosAttribute.LowerManaCost, "Lower Mana Cost", AttributeCategory.Magic, 5, 50 ),
			new AttributeInfo( AosAttribute.LowerRegCost, "Lower Reagent Cost", AttributeCategory.Magic, 5, 50 ),
		...
		public static WeaponAttributeInfo[] m_WeaponAttributes = new WeaponAttributeInfo[]
		{
			...
			new WeaponAttributeInfo( AosWeaponAttribute.ResistFireBonus, "Resist Fire Bonus", AttributeCategory.Resists, 5, 25 ),
			new WeaponAttributeInfo( AosWeaponAttribute.ResistColdBonus, "Resist Cold Bonus", AttributeCategory.Resists, 5, 25 ),
			new WeaponAttributeInfo( AosWeaponAttribute.ResistPoisonBonus, "Resist Poison Bonus", AttributeCategory.Resists, 5, 25 ),
			new WeaponAttributeInfo( AosWeaponAttribute.ResistEnergyBonus, "Resist Energy Bonus", AttributeCategory.Resists, 5, 25 ),
		...
		{
            new ResistanceTypeInfo( ResistanceType.Physical, "Physical Resistance", AttributeCategory.Resists, 2, 25 ),
            new ResistanceTypeInfo( ResistanceType.Fire, "Fire Resistance", AttributeCategory.Resists, 2, 25 ),
            new ResistanceTypeInfo( ResistanceType.Cold, "Cold Resistance", AttributeCategory.Resists, 2, 25 ),
            new ResistanceTypeInfo( ResistanceType.Poison, "Poison Resistance", AttributeCategory.Resists, 2, 25 ),
            new ResistanceTypeInfo( ResistanceType.Energy, "Energy Resistance", AttributeCategory.Resists, 2, 25 )
        };

        //Jewel & Clothing Specific Resists
        public static ElementAttributeInfo[] m_ElementAttributes = new ElementAttributeInfo[]
		{
            new ElementAttributeInfo( AosElementAttribute.Physical, "Physical Resistance", AttributeCategory.Resists, 2, 25 ),
            new ElementAttributeInfo( AosElementAttribute.Fire, "Fire Resistance", AttributeCategory.Resists, 2, 25 ),
            new ElementAttributeInfo( AosElementAttribute.Cold, "Cold Resistance", AttributeCategory.Resists, 2, 25 ),
            new ElementAttributeInfo( AosElementAttribute.Poison, "Poison Resistance", AttributeCategory.Resists, 2, 25 ),
            new ElementAttributeInfo( AosElementAttribute.Energy, "Energy Resistance", AttributeCategory.Resists, 2, 25 )
        };
	}
