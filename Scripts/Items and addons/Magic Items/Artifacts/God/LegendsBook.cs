	...
	public class LegendsBook : Item
	{
		...
		public class LegendsBookGump : Gump
		{
			...
			public override void OnResponse( NetState state, RelayInfo info )
			{
				...
				if ( fame >= 15000 && karma >= 15000 && from.TotalGold >= 20000 ){ canChoose = true; }
				else if ( fame >= 15000 && karma <= -15000 && from.TotalGold >= 20000 ){ canChoose = true; }
				...
				else if ( canChoose == true && info.ButtonID > 0 && info.ButtonID < 272 && pack.ConsumeTotal(typeof(Gold), 10000))
				{
