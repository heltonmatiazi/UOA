		...
		private class OilTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				else if ( iOil is BaseWeapon )
				{
					...
					{
						if ( m_Oil.Name == "wood polish ( oak )" ){ xOil.Resource = CraftResource.OakTree; }
						else if ( m_Oil.Name == "wood polish ( ash )" ){ xOil.Resource = CraftResource.AshTree; }
						else if ( m_Oil.Name == "wood polish ( cherry )" ){ xOil.Resource = CraftResource.CherryTree; }
						else if ( m_Oil.Name == "wood polish ( walnut )" ){ xOil.Resource = CraftResource.WalnutTree; }
						else if ( m_Oil.Name == "wood polish ( golden oak )" ){ xOil.Resource = CraftResource.GoldenOakTree; }
						else if ( m_Oil.Name == "wood polish ( ebony )" ){ xOil.Resource = CraftResource.EbonyTree; }
						else if ( m_Oil.Name == "wood polish ( hickory )" ){ xOil.Resource = CraftResource.HickoryTree; }
						else if ( m_Oil.Name == "wood polish ( pine )" ){ xOil.Resource = CraftResource.PineTree; }
						else if ( m_Oil.Name == "wood polish ( rosewood )" ){ xOil.Resource = CraftResource.RosewoodTree; }
						else if ( m_Oil.Name == "wood polish ( mahogany )" ){ xOil.Resource = CraftResource.MahoganyTree; }
						else if ( m_Oil.Name == "wood polish ( driftwood )" ){ xOil.Resource = CraftResource.DriftwoodTree; }
